...
class Database {
	...
	public String t=dtf2.format(now2);
	//public String roll;
	...
	public void insert1() {
		...
		String sql = "INSERT INTO attendance (FNAME,LNAME,ROLL_NO,DATE,TIME) VALUES (?, ?, ?, ?,?)";
		...
		try {
			...
			//tatement.setString(1, );
			statement.setString(1, this.fname);

			statement.setString(2, this.Lname);
			statement.setString(3, this.roll);
			statement.setString(4, this.d);
			statement.setString(5, this.t);
